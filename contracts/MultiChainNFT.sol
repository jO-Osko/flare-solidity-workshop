...
contract MultiChainNft is ERC721 {
    ...
    function initialize_ftso_names() private {
        string[5] memory chains = ["ALGO", "BTC", "LTC", "XRP", "DOGE"];
    ...
    constructor(
        ...
        string
            memory multiChainNFTIPFS = "QmULXyVNvLc9fF5WbWoPBq5Y3bK9DTkQ7tQLTB2LaqGjmu";
        _tokenURIs[0] = multiChainNFTIPFS;
